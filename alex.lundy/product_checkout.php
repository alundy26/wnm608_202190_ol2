...
<div class="form-control">
    <div class ="grid gap">
        <div class="col-xs-12 col-md-6">
            ...
            <input id ="payment-exiration" type="text" placeholder="MM-YY" class="form-input">
</div>
<div class ="grid gap">
        <div class="col-xs-12 col-md-6">
            <label for="payment-cvv" class="form-label">CVV</label>
            <input id ="payment-cvv" type="text" placeholder="MM-YY" class="form-input">
</div>
</div>
</div>
<div class="form-control">
...
<div class="col-xs-12 col-md-5">
    <div class="card soft">
        ...
        echo array_reduce($cart,function($r,$o){
           $totalfixed = number_format($o->price,2,'.','');
